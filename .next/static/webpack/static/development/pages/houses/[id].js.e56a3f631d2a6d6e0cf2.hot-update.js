...
var parseDate = function parseDate(str, format, locale) {
  ...
  return react_day_picker__WEBPACK_IMPORTED_MODULE_3___default.a.DateUtils.isDate(parsed) ? parsed : null;
};
